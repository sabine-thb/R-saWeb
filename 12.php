...
<body id="body" class="light-mode">
    ...
    <main>
        <?php
            ...
            $requete="SELECT * FROM destination WHERE id_dest=12";
                    ...
                    <div class='ficheDest'>
                        ...
                        <div class='texte'>
                            ...
                            <div class='containerDestAssoc'>
                                <a href='2.php' class='destAssoc' >Dragonstone</a>
                                <a href='5.php' class='destAssoc'>Mer Dothrak</a>
                                <a href='10.php' class='destAssoc'>Mereen</a>
                            </div>
                        </div>
                    </div>
                    <div>
